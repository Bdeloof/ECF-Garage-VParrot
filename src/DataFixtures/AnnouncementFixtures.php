...
class AnnouncementFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $announcement->setPicture("{{ path('images/annonces/bmw-x1.jpg') }}");
        ...
        $announcement->setTechnicalInfo('faible consommation sur autoroute, toutes options');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/citroen-c3aircross.jpg') }}");
        ...
        $announcement->setTechnicalInfo('faible consommation en ville');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/hyundai-i20.jpg') }}");
        ...
        $announcement->setTechnicalInfo('Conduite agréable, idéal pour la circulation en ville');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/mercedes-classea.jpg') }}");
        ...
        $announcement->setTechnicalInfo('Consommation importante en ville');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/mini-coopers.jpg') }}");
        ...
        $announcement->setTechnicalInfo('idéal pour la conduite en ville avec sa boite automatique');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/peugeot-208.jpg') }}");
        ...
        $announcement->setTechnicalInfo('Petite taille, idéal pour se stationner en centre ville');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/renault-clio.jpg') }}");
        $announcement->setTitle('Renault Clio');
        $announcement->setDescription('Renault Clio année 2016 de couleur rouge');
        $announcement->setTechnicalInfo('Voiture plus toute jeune, quelques frais à venir sur le moteur et l\'embrayage');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/skoda-fabia.jpg') }}");
        ...
        $announcement->setTechnicalInfo('Carrosserie intacte, Careplay, GPS intégré');
        ...
        $announcement = new Announcement();
        $announcement->setPicture("{{ path('images/annonces/wolksvagen-polo.jpg') }}");
        ...
        $announcement->setTechnicalInfo('légère rayures sur le parechoc arrière, GPS intégré');
